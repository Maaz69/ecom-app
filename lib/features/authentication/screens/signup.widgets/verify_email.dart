...
import 'package:ecom/features/authentication/controllers/signup/verify_email_controller.dart';
      ...
      body: SingleChildScrollView(
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            SizedBox(height: TSizes.spaceBtwItems),
                SizedBox(width: double.infinity, child: TextButton(onPressed: () => controller.checkEmailVerificationStatus(), child: Text(TTexts.resendEmail))),
            ],
          ),
        ),
      ),
